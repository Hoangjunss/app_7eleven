...
public interface OrderItemRepository extends JpaRepository<OrderItem, Long> {
    ...
    @Query("SELECT new com._eleven.shop.dto.CategoryRevenueResponse(p.category.id, p.category.name, SUM(oi.subtotal)) " +
    ...
    List<com._eleven.shop.dto.CategoryRevenueResponse> findCategoryRevenueBetween(@Param("startDate") OffsetDateTime startDate, @Param("endDate") OffsetDateTime endDate);
}
